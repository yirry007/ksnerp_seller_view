...
function ExcelTemplateCreate(props) {
    ...
    const getExportFields = async (type) => {
        ...
        res.code === '' && setExportFields(res.result.map((v) => (
            {
    ...
    const onSubmit = async (values) => {
        ...
        const res = await ExcelTemplateAction.store({...values, fields: fieldsList});
        res && props.created();
...
export default ExcelTemplateCreate;