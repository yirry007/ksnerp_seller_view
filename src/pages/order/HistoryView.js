...
function HistoryView(props) {
    ...
    const getOrder = async () => {
        const res = await OrderAction.historyView(props.order_id);
    ...
    return (
        <Spin spinning={loading}>
            ...
            <Row>
                ...
                <Col span={8}>
                    <DescriptionItem title={__('Invoice number 1.')} content={order.invoice_number_1} />
                </Col>
            </Row>
            <Row>
                <Col span={24}>
                    <DescriptionItem title={__('Invoice number 2.')} content={order.invoice_number_2} />
                </Col>
            </Row>
        </Spin>
    );
