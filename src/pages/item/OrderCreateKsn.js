...
function OrderCreateKsn(props) {
        ...
        if (res.code === '') {
            ...
            res.result.forEach(v => {
                ...
                _rowData[v.ksn_code] = {
                    ...
                    name: v.name_1 + ' | ' + v.name_2,
                    phone: v.phone_1 + ' | ' + v.phone_2,
    ...
    const createOrders = async () => {
        ...
        const res = await SupplierAction.createOrders({market: props.market, address: null, items: _rowDatas});
